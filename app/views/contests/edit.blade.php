...
@section('content')
	{{ Form::model($contest, array('url' => route('user.contests.update', ['contests'=>$contest->id]), 'method' => 'put', 'id' => 'formulire', 'class'=>'cmxform form-horizontal tasi-form', 'files' => 'true' ))}}
		@include('contests._forme')
	{{ Form::close() }}
@stop
