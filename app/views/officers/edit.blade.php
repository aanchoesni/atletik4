...
@section('content')
	{{ Form::model($officer, array('url' => route('user.officers.update', ['officers'=>$officer->id]), 'method' => 'put', 'id' => 'officer', 'class'=>'cmxform form-horizontal tasi-form', 'files' => 'true' ))}}
		@include('officers._forme')
	{{ Form::close() }}
@stop
