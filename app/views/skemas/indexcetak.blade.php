...
<div class="row">
    <div class="col-lg-12">
        <section class="panel">
            ...
            {{ Form::open(array('url' => route('admin.cetakskema'), 'method' => 'get','class'=>'form-inline', 'id' => 'cetakskema')) }}
            <div class="panel-body"  style:"overflow: scroll;">
              <div class="form-inline">
                ...
                <div class="form-group">
                {{ Form::label('tipe', 'No.Lint/No.Urut') }}
                {{ Form::select('tipe', array(''=>'', 'nolint'=>'No. Lintasan', 'nourut'=>'No. Urut'), null, array(
                        'id'=>'tipe',
                        'placeholder' => "Pilih tipe",
                        'class'=>'form-control input-sm')) }}
                </div>
                <div class="form-group">
                {{ Form::label('output', 'Output File') }}
                {{ Form::select('output', array(''=>'', 'PDF'=>'PDF', 'EXCEL'=>'EXCEL'), null, array(
                        'id'=>'output',
              ...
              <br>
              <div class="form-group">
                {{ Form::button('Cetak', array('type'=>'submit','class'=>'btn btn-success')) }}
              </div>
            {{ Form::close() }}
        </section>
    </div>
...
@section('script')
  ...
  <script type="text/javascript">
      ...
      $(document).ready(function() { $("#seri").select2(); });
      $(document).ready(function() { $("#jenjang").select2(); });
      $(document).ready(function() { $("#nocontest").select2({ dropdownAutoWidth : true }); });
      $(document).ready(function() { $("#tipe").select2(); });
      $(document).ready(function() { $("#output").select2(); });
  </script>
